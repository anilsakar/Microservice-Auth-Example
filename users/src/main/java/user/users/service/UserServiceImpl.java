...
public class UserServiceImpl implements IUserService {
    ...
    public UserDTO createUser(UserDTO userDTO) {
        ...
        System.out.println(userEntity.getUserDetail().toString());
        ...
        System.out.println(environment.getProperty("confirm.mail.url").toString() + "test");
    ...
    /// -----------------------This method imported from Spring
    /// UserDetailsService-----------------------
    @Override
    ...
    public UserDetailDTO updateUserDetail(UserDetailDTO userDetailDTO) {
        ...
        userDetailEntity.setProfilePicture(userDetailDTO.getProfilePicture());
    ...
    @Override
    public String uploadImage(MultipartFile profilePicture) {

        /// Send feign request to the AmazonS3Bucket microservice to upload the picture
        /// and get the url.
        String profilePictureUrl = amazonS3ServiceClient.getPictureUrl(profilePicture);
